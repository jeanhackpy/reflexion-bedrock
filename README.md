...
environment including Ollama for your local LLMs, Open WebUI and LobeChat for interfaces to chat with your AI, and Supabase for your database, vector store, and authentication.

This is Cole's version with a couple of improvements and the addition of Supabase, Open WebUI, Flowise, Neo4j, Langfuse, SearXNG, Caddy, Moltbot (OpenClaw), and LobeChat!
...
✅ [**Moltbot (OpenClaw)**](https://openclaw.ai/) - Personal AI assistant gateway with secure tool sandboxing and multi-channel messaging.

✅ [**LobeChat**](https://lobehub.com/) - Modern, high-performance AI chat interface with a great UI and plugin system.
...
2. Set the following required environment variables:
   ...
   # Moltbot Secrets
   ############
   # This will be auto-generated by start_services.py if left blank
...
3. Set the following environment variables if deploying to production, otherwise leave commented:
   ...
   MOLTBOT_HOSTNAME=moltbot.yourdomain.com
   LOBECHAT_HOSTNAME=lobechat.yourdomain.com
...
### Using Moltbot & LobeChat

This package includes **Moltbot (OpenClaw)** for agentic capabilities and **LobeChat** for a premium chat experience.

1. **Moltbot Gateway**: Moltbot is automatically configured to use your local Ollama instance. It provides a secure gateway for AI agents to execute tools in isolated sandboxes.
   - Access the Gateway UI: `http://localhost:8009` (or `http://localhost:18789`)
   - Authentication: Use the `OPENCLAW_GATEWAY_TOKEN` generated in your `.env` file.
2. **LobeChat**: A modern UI that comes pre-integrated with both Ollama and Moltbot.
   - Access LobeChat: `http://localhost:8010` (or `http://localhost:3210`)
   - Configuration: LobeChat is already set up to route requests through Moltbot for agentic tasks or directly to Ollama for fast inference.

To open n8n at any time, visit <http://localhost:8001/> (or 5678) in your browser.
To open Open WebUI at any time, visit <http://localhost:8002/> (or 3000).
To open LobeChat at any time, visit <http://localhost:8010/> in your browser.
To open Moltbot Gateway at any time, visit <http://localhost:8009/> in your browser.
